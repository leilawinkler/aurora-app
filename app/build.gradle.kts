...
dependencies {
    // Room: la base de datos local del telefono
...
// Las librerias de Supabase/Ktor traen su propia version de la biblioteca
// base de Kotlin. Esto la fija en la que usa el compilador del proyecto.
